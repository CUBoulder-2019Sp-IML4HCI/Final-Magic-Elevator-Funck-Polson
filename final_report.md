...
In addition to the mentioned hard skills, this project was as a great showcase of soft skills, an example of how interdisciplinary teams can succeed when sharing knowledge. The Magic Elevator was borne out of the well-functioning collaboration between a computer scientists and a mechanical engineer. Contributing to the project, either from the software or the hardware side, enabled mutual learning in many instances.  
