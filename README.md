...
A LEGO assembly is built on the acrylic sheet. Since many different variations of elevator panels exist, we will forgoe a detailed construction manual. However, two critical LEGO components have proven to be suitable for the assembly. First, the LEGO Mindstorms Interactive Motor (9842), and second, two LEGO Technic mini linear actuators (92693). Working with gears and belts, the clockwise and counterclockwise rotational movement of the motor can be transferred to extend two linear actuators in opposing directions. These two LEGO components are shown in the picture below.
